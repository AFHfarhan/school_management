...
<body id="page-top">
        ...
        <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">Tekan "Logout" dibawah jika sudah siap meninggalkan aplikasi.</div>
    ...
    <script src="{{ asset('/global_assets/vendor/jquery/jquery.min.js') }}"></script>
    <script src="{{ asset('/global_assets/vendor/bootstrap/js/bootstrap.bundle.min.js') }}"></script>

    <!-- Core plugin JavaScript-->
    <script src="{{ asset('/global_assets/vendor/jquery-easing/jquery.easing.min.js') }}"></script>

    <!-- Custom scripts for all pages-->
    <script src="{{ asset('/global_assets/js/sb-admin-2.min.js') }}"></script>
