...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form id="studentForm" action="{{ route('v1.student.update') }}" method="POST" >
                @csrf
                @method('PUT')
                <!-- row header -->
                <div class="row">
                ...
                <div class="row">
                    <div class="col-lg-6" >
                        ...
                        <select class="form-select form-select-lg form-control" name="data[personal][gender]" id="inputJenisKelamin"  aria-label="Pilih Jenis Kelamin">
                            ...
                            <option value="laki" {{ old('data[personal][gender]', $student->data['personal']['gender'] ?? '') == 'laki' ? 'selected' : '' }}>Laki - laki</option>
                            <option value="perempuan" {{ old('data[personal][gender]', $student->data['personal']['gender'] ?? '') == 'perempuan' ? 'selected' : '' }}>Perempuan</option>
                        </select>
                        ...
                        <div id="checkboxReferensi" class="row form-check">
                            ...
                            <div class="form-check  col-md-8">
                                ...
                                <label class="form-check-label " for="cbdrf5">
                                    Guru
                                </label> <input type="text" class="form-control" id="inputGuruRef" name="inputGuruRef" value="{{ old('inputGuruRef', data[other][guru]) }}">
                            </div>
                            <div class="form-check  col-md-8">
                                ...
                                <label class="form-check-label " for="cbdrf6">
                                    Teman
                                </label><input type="text" class="form-control" id="inputTemanRef" name="inputTemanRef" value="{{ old('name', data[other][reference_friends]) }}">
                            </div>
                            <div class="form-check  col-md-6">
