        ...
        <div class="card-body">
            <form id="studentForm" action="{{ route('v1.students.update', $student) }}" method="POST" >
                ...
                <div class="row">
                    <div class="col-lg-6">
                        @php 
                            $formdate = old('data.form_date', $data['form_date'] ?? [[]]); 
                            $formdateParts = explode('/', $formdate);
                            $formhDay = $formdateParts[0] ?? '';
                            $formhMonth = $formdateParts[1] ?? '';
                            $formYear = $formdateParts[2] ?? '';
                        @endphp
                        <label for="inputTanggal" class="form-label">Tanggal</label>
                        <div class="input-group" id="inputTanggal">
                            <input type="text" class="form-control" placeholder="Tanggal" name="formgruptanggal" id="formgruptanggal" value="{{ old('formhDay',$formhDay) }}" aria-label="Tanggal">
                            <span class="input-group-text form-control" style="display:inline-block;">/</span>
                            <input type="text" class="form-control" placeholder="Bulan" name="formgrupbulan" id="formgrupbulan"  value="{{ old('formhMonth',$formhMonth) }}" aria-label="Bulan">
                            <span class="input-group-text form-control" style="display:inline-block;">/</span>
                            <input type="text" class="form-control" placeholder="Tahun" name="formgruptahun" id="formgruptahun"  value="{{ old('formYear',$formYear) }}" aria-label="Tahun">
                        </div>
                    ...
                    <div class="col-lg-6">
                         @php 
                            $regdate = old('data.form_reg', $data['form_reg'] ?? [[]]); 
                        ...
                        <div class="input-group mb-3" id="inputReg">
                            <input type="text" class="form-control" placeholder="Reg" name="formgrupReg1" value="{{ old('regDay',$regDay) }}" id="formgrupReg1" aria-label="Reg1">
                            <span class="input-group-text form-control" style="display:inline-block;">/</span>
                            <input type="text" class="form-control" placeholder="Reg" name="formgrupReg2" value="{{ old('regMonth',$regMonth) }}" id="formgrupReg2" aria-label="Reg2">
                            <span class="input-group-text form-control" style="display:inline-block;">/</span>
                            <input type="text" class="form-control" placeholder="Reg" name="formgrupReg3" value="{{ old('regYear',$regYear) }}" id="formgrupReg3" aria-label="Reg3">
                        </div>
                    </div>
                </div>
                <hr></hr>
                ...
                <div class="row">
                    <div class="col-lg-6" >
                        ...
                        <div class="input-group" id="inputTTL">
                            <div class="row">
                                ...
                                @php 
                                    $birthdate = old('data.personal.birthdate', $data['personal']['birthdate'] ?? [[]]); 
                                ...
                                <div class="input-group col-md-8">
                                    <input type="text" class="form-control" placeholder="tgl" name="formgrupTTLTanggal" value="{{ old('birthDay', $birthDay) }}" id="formgrupTTLTanggal" aria-label="Tanggal">
                                    <span class="input-group-text form-control" style="display:inline-block;">/</span>
                                    <input type="text" class="form-control" placeholder="bln" name="formgrupTTLBulan" value="{{ old('birthMonth',$birthMonth) }}" id="formgrupTTLBulan" aria-label="Bulan">
                                    <span class="input-group-text form-control" style="display:inline-block;">/</span>
                                    <input type="text" class="form-control" placeholder="thn" name="formgrupTTLTahun" value="{{ old('birthYear',$birthYear) }}" id="formgrupTTLTahun" aria-label="Tahun">    
                                </div>
                            </div>
                        </div>
                        ...
                        <select class="form-select form-select-lg form-control" name="data[personal][religion]" value="" id="inputAgama"  aria-label="Pilih Agama">
                            <option selected disabled>Pilih salah satu</option>
                            <option value="islam" {{ old('data[personal][religion]', $student->data['personal']['religion'] ?? '') == 'islam' ? 'selected' : '' }}>Islam</option>
                            <option value="kristen" {{ old('data[personal][religion]', $student->data['personal']['religion'] ?? '') == 'kristen' ? 'selected' : '' }}>Kristen</option>
                            <option value="katholik" {{ old('data[personal][religion]', $student->data['personal']['religion'] ?? '') == 'katholik' ? 'selected' : '' }}>Katholik</option>
                            <option value="hindu" {{ old('data[personal][religion]', $student->data['personal']['religion'] ?? '') == 'hindu' ? 'selected' : '' }}>Hindu</option>
                            <option value="budha" {{ old('data[personal][religion]', $student->data['personal']['religion'] ?? '') == 'budha' ? 'selected' : '' }}>Budha</option>
                            <option value="konguchu" {{ old('data[personal][religion]', $student->data['personal']['religion'] ?? '') == 'konguchu' ? 'selected' : '' }}>Konguchu</option>
                        </select>
                        ...
                        <input type="text" class="form-control" name="data[personal][kks_no]" value="{{ old('data.personal.kks',$data['personal']['kks_no']) }}" id="inputKks" >
                        ...
                        <div id="radiobuttonKPS" class="row form-check">
                            <div class="form-check col-md-6">
                                <input class="form-check-input " type="radio" name="data[personal][kps]" value="ya" id="rbKpsYa" {{ old('data[personal][kps]', $student->data['personal']['kps'] ?? '') == 'ya' ? 'checked' : '' }}>
                                <label class="form-check-label " for="rbKpsYa">
                                    Ya
                                </label>
                            </div>
                            <div class="form-check  col-md-6">
                                <input class="form-check-input " type="radio" name="data[personal][kps]" value="tidak" id="rbKpsTidak" {{ old('data[personal][kps]', $student->data['personal']['kps'] ?? '') == 'ya' ? 'checked' : '' }}>
                        ...
                        <div id="radiobuttonKIP" class="row form-check">
                            <div class="form-check col-md-6">
                                <input class="form-check-input " type="radio" name="data[personal][kip]" value="ya" id="rbKipYa" {{ old('data[personal][kip]', $student->data['personal']['kip'] ?? '') == 'ya' ? 'checked' : '' }}>
                                <label class="form-check-label " for="rbKipYa">
                                    Ya
                                </label>
                            </div>
                            <div class="form-check  col-md-6">
                                <input class="form-check-input " type="radio" name="data[personal][kip]" value="tidak" id="rbKipTidak" {{ old('data[personal][kip]', $student->data['personal']['kip'] ?? '') == 'tidak' ? 'checked' : '' }}>
                    ...
                    <div class="col-lg-6">
                        ...
                        <input type="text" class="form-control" name="data[personal][homephone]" value="{{ old('data.personal.homephone',$data['personal']['homephone']) }}" id="inputNoTelp" >

                        <label for="inputNoHp" class="form-label" style="margin-top:20px;">No. HP</label>
                        <input type="text" class="form-control" name="data[personal][phone]" value="{{ old('data.personal.phone',$data['personal']['phone']) }}" id="inputNoHp" >
                ...
                <div class="row">
                    <div class="table-responsive">
                        <table class="table table-bordered" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                <tr>
                                    <td><input type="text" class="form-control" name="data[achievement][type]" value="{{ old('data.achievement.type',$data['achievement']['type']) }}" id="jenisPrestasi1"></td>
                                    <td><input type="text" class="form-control" name="data[achievement][grade]" value="{{ old('data.achievement.grade',$data['achievement']['grade']) }}" id="tingkatPrestasi1"></td>
                                    <td><input type="text" class="form-control" name="data[achievement][name]" value="{{ old('data.achievement.name',$data['achievement']['name']) }}" id="namaPrestasi1"></td>
                                    <td><input type="text" class="form-control" name="data[achievement][year]" value="{{ old('data.achievement.year',$data['achievement']['year']) }}" id="tahunPrestasi1"></td>
                                    <td><textarea class="form-control" id="penyelenggaraPrestasi1" name="data[achievement][credit]" value="" rows="2" cols="5">{{ old('data.achievement.credit',$data['achievement']['credit']) }}</textarea></td>
                                </tr>
                                <tr>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <div id="checkboxPersyaratan" class="row form-check">
                            <div class="form-check col-md-6">
                                <input class="form-check-input " type="checkbox"  name="data[other][requirements][]" value="formulir" id="cbdft1" {{ in_array('form', old('data[other][requirements]', $student->data['other']['requirements'] ?? [])) ? 'checked' : '' }}>
                                <label class="form-check-label " for="cbdft1">
                                    1. Mengisi Formulir
                                </label>
                            </div>
                            <div class="form-check  col-md-6">
                                <input class="form-check-input " type="checkbox"  name="data[other][requirements][]" value="fckk" id="cbdft2" {{ in_array('form', old('data[other][requirements]', $student->data['other']['requirements'] ?? [])) ? 'checked' : '' }}>
                                <label class="form-check-label " for="cbdft2">
                                    2. Fotokopi KK 
                                </label>
                            </div>
                            <div class="form-check  col-md-6">
                                <input class="form-check-input " type="checkbox"  name="data[other][requirements][]" value="fcktportu" id="cbdft3" {{ in_array('form', old('data[other][requirements]', $student->data['other']['requirements'] ?? [])) ? 'checked' : '' }}>
                                <label class="form-check-label " for="cbdft3">
                                    3. Fotokopi KTP Orang Tua
                                </label>
                            </div>
                            <div class="form-check  col-md-8">
                                <input class="form-check-input " type="checkbox"  name="data[other][requirements][]" value="fotowarna" id="cbdft4" {{ in_array('form', old('data[other][requirements]', $student->data['other']['requirements'] ?? [])) ? 'checked' : '' }}>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div id="checkboxReferensi" class="row form-check">
                            <div class="form-check col-md-6">
                                <input class="form-check-input " type="checkbox" name="data[other][reference][]" value="web" id="cbdrf1" {{ in_array('form', old('data[other][reference]', $student->data['other']['reference'] ?? [])) ? 'checked' : '' }}>
                                <label class="form-check-label " for="cbdrf1">
                                    Website
                                </label>
                            </div>
                            <div class="form-check  col-md-6">
                                <input class="form-check-input " type="checkbox" name="data[other][reference][]" value="facebook" id="cbdrf2" {{ in_array('form', old('data[other][reference]', $student->data['other']['reference'] ?? [])) ? 'checked' : '' }}>
                                <label class="form-check-label " for="cbdrf2">
                                    Facebook
                                </label>
                            </div>
                            <div class="form-check  col-md-6">
                                <input class="form-check-input " type="checkbox" name="data[other][reference][]" value="banner" id="cbdrf3" {{ in_array('form', old('data[other][reference]', $student->data['other']['reference'] ?? [])) ? 'checked' : '' }}>
                                <label class="form-check-label " for="cbdrf3">
                                    Spanduk
                                </label>
                            </div>
                            <div class="form-check  col-md-6">
                                <input class="form-check-input " type="checkbox" name="data[other][reference][]" value="brosur" id="cbdrf4" {{ in_array('form', old('data[other][reference]', $student->data['other']['reference'] ?? [])) ? 'checked' : '' }}>
                                <label class="form-check-label " for="cbdrf4">
                                    Brosur
                                </label>
                            </div>
                            <div class="form-check  col-md-8">
                                <input class="form-check-input " type="checkbox" name="data[other][reference][]" value="guru" id="cbdrf5" {{ in_array('form', old('data[other][reference]', $student->data['other']['reference'] ?? [])) ? 'checked' : '' }}>
                                <label class="form-check-label " for="cbdrf5">
                                    Guru
                                </label> <input type="text" class="form-control" id="inputGuruRef" name="inputGuruRef" value="">
                            </div>
                            <div class="form-check  col-md-8">
                                <input class="form-check-input " type="checkbox" name="data[other][reference][]" value="teman" id="cbdrf6" {{ in_array('form', old('data[other][reference]', $student->data['other']['reference'] ?? [])) ? 'checked' : '' }}>
                            ...
                            <div class="form-check  col-md-6">
                                <input class="form-check-input " type="checkbox" name="data[other][reference][]" value="lainnya" id="cbdrf7" {{ in_array('form', old('data[other][reference]', $student->data['other']['reference'] ?? [])) ? 'checked' : '' }}>
